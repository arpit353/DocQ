<!DOCTYPE html>
  <html>
    ...
    <div class="container">
        ...
        <br><br>
        <h4 class="center white-text"><b>Hi, Vedant</b></h4>
        ...
        <div class="row">
            ...
            <div class="col s3">
                <div class="feature">
                    ...
                    <h4 style="margin-top: 0px; font-size: 1.8rem; color:#676767" class="center"><a style="color:#676767" href=""><b>Nearby<br>Clinics</b></a></h4>
                </div>
            </div>
            <div class="col s3">
                <div class="feature">
                    <img class="center" src="assets/images/yoga.png">
                    <h4 style="margin-top: 0px; font-size: 1.8rem; color:#676767" class="center"><a style="color:#676767" href=""><b>Fitness<br>Suggestions</b></a></h4>
                </div>
            </div>
        </div>
    </div>
