    ...
    <div class="container">
        ...
        <div class="row">
          ...
          <div style="background-color:white; border-radius: 40px; padding:25px 50px; text-align: justify;" class="col s12 offset-m2 m8 offset-l2 l8">
            ...
            <div class="col s3" style="background-image:url('view.php?id=<?php echo $row['id']; ?>'); background-repeat: no-repeat; background-size: contain; background-position: center; height: 165px;">
