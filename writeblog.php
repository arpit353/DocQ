			...
			<form method="POST" action="writeblog.php" class="col s12">
				<div class="row">
			        ...
			        <div class="col s12">
					    ...
					    <p class="col s12 m4 l3">
					      <input name="topic" type="radio" id="neurology" value="cardiology"  />
					      <label for="neurology">Neurology</label>
					    </p>
					    <p class="col s12 m4 l3">
					      <input name="topic" type="radio" id="Haematology"   value="cardiology" />
					      <label for="Haematology">Haematology</label>
					    </p>
					    <p class="col s12 m4 l3">
					      <input name="topic" type="radio" id="Opthalmology" value="cardiology" />
					      <label for="Opthalmology">Opthalmology</label>
					    </p>
					    <p class="col s12 m4 l3">
					      <input name="topic" type="radio" id="cardiolog"  value="cardiology" />
					      <label for="cardiolog">Cardiology</label>
					    </p>
					    <p class="col s12 m4 l3">
					      <input name="topic" type="radio" id="neurolog"  value="cardiology" />
					      <label for="neurolog">Neurology</label>
					    </p>
					    <p class="col s12 m4 l3">
					      <input name="topic" type="radio" id="Haematoogy"  value="cardiology"  />
					      <label for="Haematoogy">Haematology</label>
					    </p>
					    <p class="col s12 m4 l3">
					      <input name="topic" type="radio" id="Opthaology" value="cardiology" />
					      <label for="Opthalology">Opthalmology</label>
					    </p>
					    <p class="col s12 m4 l3">
					      <input name="topic" type="radio" id="cardology" value="cardiology"  />
					      <label for="cardology">Cardiology</label>
					    </p>
					    <p class="col s12 m4 l3">
					      <input name="topic" type="radio" id="neurolgy"  value="cardiology" />
					      <label for="neurolgy">Neurology</label>
					    </p>
					    <p class="col s12 m4 l3">
					      <input name="topic" type="radio" id="Haematoogy" value="cardiology"   />
					      <label for="Haematoogy">Haematology</label>
					    ...
					    <p class="col s12 m4 l3">
					      <input name="topic" type="radio" id="Opthalology" value="cardiology" />
					      <label for="Opthalology">Opthalmology</label>
					    </p>
				    </div>
...
if($result1 = mysqli_query($link, $sql2)){
	if(mysqli_num_rows($result1) > 0){
	    ...
	    <div class="card-action">
			...
			<a href="add_likes_blog.php?id=<?php echo $row1['bid']; ?>&action=like" style="color: green;">Upvote <i class="material-icons">check</i></a>
			<a href="add_likes_blog.php?id=<?php echo $row1['bid']; ?>&action=unlike" style="color: orange;">Downvote<i class="material-icons">close</i></a>
		</div>
	  </div>
